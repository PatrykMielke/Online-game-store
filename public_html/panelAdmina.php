...
$sql = "
    ...
    FROM `{$prefix}posiadane_programy` pp
    JOIN `{$prefix}produkty` p ON pp.id_produktu = p.id_produktu
    GROUP BY p.nazwa
";
        ...
        options: {
            scales: {
                y: {
                    beginAtZero: true,
                    ticks: {
                        stepSize: 1 // Ensure the Y-axis shows integers
                    },
                    grid: {
                        drawBorder: true, // Draw border at the end of the y-axis
                    }
                },
                x: {
                    ticks: {
                    ...
                    grid: {
                        drawBorder: true, // Draw border at the end of the x-axis
                        drawOnChartArea: false, // Ensure grid lines are drawn only on tick marks
                    }
                }
            }
        }
